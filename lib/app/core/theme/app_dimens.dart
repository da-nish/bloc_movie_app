mixin Dimens {
  static const double commonBorderWidth = .6;
  ...
  static const double paddingNull = 0;
  ...
  static const Duration duration1s = Duration(milliseconds: 1000);
  static const Duration duration2s = Duration(milliseconds: 2000);
  static const Duration duration3s = Duration(milliseconds: 3000);
  static const Duration duration4s = Duration(milliseconds: 4000);
  static const Duration duration5s = Duration(milliseconds: 5000);
