...
// void _tempPrint(Object? object) {
//   print(object);
//   // print("========log ${Application.gcl == null}");

//   // if (Application.gcl != null) {
//   //   Application.gcl?.writeLog(
//   //       level: DateTime.now().toString(), message: object.toString());
//   // }
// }

class CustomAPILogger extends Interceptor {
...
class CustomLogger {
  static final CustomAPILogger _logger = CustomAPILogger();
  static void log(
      {String? header,
    ...
    if (mapData != null) {
      _logger._printMapAsTable(mapData, header: header);
      return;
    }

    _logger._printBoxed(header: header, text: text);
  }
}

void printBlue(String text) {
  // developer.log('\x1B[39m$text\x1B[0m');
  developer.log('\x1b[38;5;39m$text\x1b[0m');
}
